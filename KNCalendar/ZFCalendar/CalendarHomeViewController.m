...
- (void)setAirPlaneToDay:(int)day ToDateforString:(NSString *)todate
{
    ...
    KNDateChooseModel *dateModel = [NSKeyedUnarchiver unarchiveObjectWithData:data];
    
    
    super.calendarMonth = [self getMonthArrayOfDayNumber:daynumber ToDateforString:todate dataModel:dateModel];
...
//获取时间段内的天数数组
- (NSMutableArray *)getMonthArrayOfDayNumber:(int)day ToDateforString:(NSString *)todate dataModel:(KNDateChooseModel *)dateModel
{
    ...
    return [super.Logic reloadCalendarView:date selectDate:selectdate  needDays:day dataModel:dateModel];
}
