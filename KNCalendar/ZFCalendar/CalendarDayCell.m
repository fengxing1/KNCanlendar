...
- (void)initView{
    ...
    noteLabel = [[UILabel alloc] initWithFrame:CGRectMake(2, 15, 10, 10)];
    ...
    noteLabel.frame = CGRectMake(noteLabel.frame.origin.x, day_title.frame.origin.y - 10, noteLabel.frame.size.width, noteLabel.frame.size.height);
